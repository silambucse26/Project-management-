...
function LoginScreen({ onLogin }: { onLogin: (profile: LoginForm) => Promise<string | null> }) {
  ...
  return (
    <div className="min-h-screen bg-background px-3 py-4 sm:px-4 sm:py-6 lg:px-6">
          ...
          {mode === "signin" ? (
            <div className="space-y-4">
              <div>
                ...
                <Input value={signIn.employeeId} onChange={(event) => setSignIn({ ...signIn, employeeId: event.target.value })} placeholder="ADM001" autoComplete="username" className="w-full" />
              </div>
              <div>
            ...
            <div className="space-y-4">
              <div className="grid gap-3 md:grid-cols-2">
                <div>
                  <Label>Employee ID</Label>
                  <Input value={form.employeeId} onChange={(event) => setForm({ ...form, employeeId: normalizeEmployeeId(event.target.value) })} placeholder="EMP030" autoComplete="username" className="w-full" />
                </div>
                <div>
                  <Label>Password</Label>
                  <div className="relative">
              ...
              <div>
                <Label>Name</Label>
                <Input value={form.name} onChange={(event) => setForm({ ...form, name: event.target.value })} placeholder="Enter your full name" className="w-full" />
              </div>
              <div className="grid gap-3 md:grid-cols-2">
                <div>
                  <Label>Role</Label>
              ...
              <div>
                ...
                <Input value={selectedHead ? `${selectedHead.name} - ${selectedHead.title}` : "No head assigned"} readOnly className="w-full" />
              </div>
            </div>
          )}
