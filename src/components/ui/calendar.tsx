...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      classNames={{
        root: cn("mx-auto w-full max-w-[20rem] sm:max-w-fit", defaultClassNames.root),
        months: cn("relative flex flex-col gap-4 md:flex-row md:justify-center", defaultClassNames.months),
        ...
        table: "mx-auto w-full border-collapse sm:w-fit",
